...
# Copy the standalone test-impact explorer into the generated Pages site. Its
# graph.json and repository-files.txt data files are generated by build_docs.sh.
html_extra_path = ["test-impact"]
